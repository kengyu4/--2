...
public class GlobalExceptionHandler {
    ...
    /**
     * 处理MethodArgumentNotValidException异常，用于处理@Validated验证失败的情况
     *
     * @param e 异常对象
     * @return 包含验证错误信息的ResponseEntity
     */
    ...
    public ResponseEntity<Result> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        return ResponseEntity.badRequest().body(Result.fail(errorMsg.toString()));
    }
